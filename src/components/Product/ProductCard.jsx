    ...
    >
      ...
      {quantity > 0 ? (
        <div className="flex flex-col md:flex-row gap-2">
          <div className="flex justify-between items-center border border-primary-500 rounded-lg flex-1 overflow-hidden">
            <button
              onClick={handleDecrement}
              className="w-1/3 text-xl font-bold py-2 text-primary-500 hover:bg-primary-100"
            >
              –
            </button>
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <button
            ...
            className="flex-1 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold py-2 rounded-xl hover:from-primary-600 hover:to-primary-700 transition-all text-sm shadow-md shadow-primary-500/20 active:scale-[0.98]"
          >
            Add to Cart
          </button>
          ...
          <button
            onClick={handleBuyNow}
            className="flex-1 border-2 border-primary-200 text-primary-600 font-semibold py-2 rounded-xl hover:border-primary-500 hover:bg-primary-50 transition-all text-sm active:scale-[0.98]"
          >
            Buy Now
          </button>
        </div>
