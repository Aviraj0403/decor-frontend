...
export default function HomeNewArrivals() {
  ...
  const addProductToCart = async (product, buyNow = false) => {
    ...
    try {
      ...
      toast.error(cartError?.message || "Unable to add product to cart");
    } finally {
      setBusyProduct(null);
    }
  };
  ...
  return (
    <section className="overflow-x-hidden bg-brand-bg px-3 py-6 sm:px-6 sm:py-8 lg:px-5">
        ...
        <div className="relative">
          ...
          >
            ...
            {!isLoading && !isError && products.length === 0 && (
              <p className="w-full py-12 text-center text-sm text-brand-text/60">No new arrivals available.</p>
            )}
                  ...
                  >
                    <div className="relative overflow-hidden rounded-xl bg-[#E2B385]">
                      ...
                      <button
                        ...
                        className="flex aspect-[1.25/1] w-full items-center justify-center overflow-hidden"
                      >
                        <img
                          src={product.pimage}
                          alt={product.name}
