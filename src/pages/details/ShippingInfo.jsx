  ...
  return (
    <section className="bg-gradient-to-br from-primary-50 to-white min-h-screen p-6 md:p-14">
      ...
      <motion.div
        ...
        className="bg-brand-bg shadow-xl rounded-3xl border border-primary-200 p-6 md:p-10 mb-16 flex flex-col md:flex-row items-center gap-6 justify-between"
      >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <motion.div
          ...
          className="bg-brand-bg shadow-lg rounded-2xl p-7 border border-primary-100 hover:shadow-primary-200 transition"
        >
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed text-sm">
            Orders may include standard shipping fees depending on the delivery location and order value.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="text-brand-text mt-3 space-y-1 text-sm">
            <li className="flex items-center gap-2"><Mail size={18} /><a href="mailto:divyamantraofficial@gmail.com" className="hover:text-primary-600">divyamantraofficial@gmail.com</a></li>
            <li className="flex items-center gap-2"><Phone size={18} /><a href="tel:+919588360684" className="hover:text-primary-600">+91 9588360684</a></li>
          </ul>
        </motion.div>
      </div>
